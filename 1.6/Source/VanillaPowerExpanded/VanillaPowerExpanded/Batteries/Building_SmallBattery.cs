...
namespace VanillaPowerExpanded
{
    ...
    public class Building_SmallBattery : Building
    {
        ...
        private static readonly Vector2 BarSize = new Vector2(0.65f, 0.4f);
        ...
        protected override void Tick()
        {
            ...
            if (this.ticksToExplode > 0)
            {
                ...
                if (this.ticksToExplode == 0)
                {
                    ...
                    GenExplosion.DoExplosion(randomCell, base.Map, radius, DamageDefOf.Flame, null, -1, -1f, null, null, null, null, null, 0f, 1, null,null,255,false, null, 0f, 1, 0f, false, null, null);
