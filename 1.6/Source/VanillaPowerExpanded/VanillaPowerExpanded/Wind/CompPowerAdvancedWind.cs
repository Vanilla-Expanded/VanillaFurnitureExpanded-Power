...
namespace VanillaPowerExpanded
{
    ...
    public class CompPowerAdvancedWind : CompPowerPlant
    {
        protected override float DesiredPowerOutput
        {
            get
            {
                return this.cachedPowerOutput * VanillaPowerExpanded_Settings.advWindmillOutputMultiplier;
            }
        }
        ...
        private float PowerPercent
        {
            get
            {
                return base.PowerOutput / (-base.Props.PowerConsumption * 1.5f);
            }
        }
        ...
        public override void PostDraw()
        {
            ...
            GenDraw.FillableBarRequest r = new GenDraw.FillableBarRequest
            {
                ...
                size = BarSize,
                fillPercent = this.PowerPercent / (VanillaPowerExpanded_Settings.advWindmillOutputMultiplier),
